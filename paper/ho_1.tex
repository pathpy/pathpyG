...
\Edge[bend=15,Direct,RGB,color={213, 94, 0},lw=2,opacity=0.8](A->B)(B->A);
\Edge[bend=15,Direct,RGB,color={213, 94, 0},lw=2,opacity=0.8](A->B)(B->C);
...
\Edge[bend=15,Direct,RGB,color={213, 94, 0},lw=2,opacity=0.8](B->C)(C->B);
\Edge[bend=15,Direct,RGB,color={213, 94, 0},lw=2,opacity=0.8](C->D)(D->C);
\Edge[bend=15,Direct,RGB,color={213, 94, 0},lw=2,opacity=0.8](D->C)(C->B);
