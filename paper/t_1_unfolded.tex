...
\begin{tikzpicture}
    ...
    \Vertex[RGB,color={36, 74, 92},size=0.3,opacity=0.75,style={draw opacity=0.75},x=-1.25,y=-0.75]{A0};
...
\Vertex[RGB,color={36, 74, 92},size=0.3,opacity=0.1,style={draw opacity=0.1},x=0.625,y=0.75]{D3};
...
\Edge[Direct,RGB,color={213, 94, 0},lw=1,opacity=0.8](A0)(B1);
\Edge[Direct,RGB,color={213, 94, 0},lw=1,opacity=0.8](C0)(D1);
...
\Edge[Direct,RGB,color={213, 94, 0},lw=1,opacity=0.8](C2)(B3);
