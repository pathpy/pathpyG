...
class Layout(object):
    ...
    Args:
        ...
        **attr: Attributes to add to node as key=value pairs.
    ...
    def __init__(self, nodes, adjacency_matrix, **attr):
        ...
        The [`Layout`][pathpyG.visualisations.layout.Layout] class is used to generate node a layout drawer
